    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-16 pt-8"> 
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Card 1: Big Sale --}}
                <a href="{{ url('/product-detail') }}" class="bg-hero-bg p-8 rounded-xl shadow-lg flex items-center justify-between transition duration-300 transform group hover:shadow-2xl hover:scale-[1.01]">
                    <div>
                ...
                <div class="bg-blue-700 p-8 rounded-xl shadow-lg flex items-center justify-between transition duration-300 transform group hover:shadow-2xl hover:scale-[1.01]">
                    <div>
                        ...
                        <a href="{{ url('/product-detail') }}" class="bg-white text-blue-700 font-bold py-2 px-4 rounded-full hover:bg-gray-100 transition duration-200 text-sm mb-1 inline-block">Shop Now</a>
                    </div>
        ...
        <section class="mb-16">
            <div class="flex justify-between items-end mb-8">
                ...
                {{-- Link All Products --}}
                <a href="{{ url('/product-detail') }}" class="text-blue-600 font-semibold hover:text-blue-800 transition duration-150 hidden sm:block">All Products &rarr;</a>
            </div>
    
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                
                {{-- Card 1: Clarinazole --}}
                <a href="{{ url('/product-detail') }}" class="bg-blue-50 p-4 rounded-xl shadow-lg transition duration-300 transform hover:shadow-xl hover:scale-[1.03] cursor-pointer">
            ...
            <div class="flex justify-end mt-4">
                <a href="{{ url('/product-detail') }}" class="text-blue-600 font-semibold hover:text-blue-800 transition duration-150 sm:hidden">All Products &rarr;</a>
            </div>
        </section>
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a href="{{ url('/product-detail') }}" class="relative bg-white p-6 rounded-xl shadow-lg h-64 overflow-hidden 
